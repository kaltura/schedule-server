 ...
 * @param byDay string Comma separated of KalturaScheduleEventRecuranceDay
 ...
 */
function KalturaScheduleEventRecurance(){
	KalturaScheduleEventRecurance.super_.call(this);
	this.name = null;
	this.frequency = null;
	this.until = null;
	this.count = null;
...
module.exports.KalturaScheduleEventRecurance = KalturaScheduleEventRecurance;

util.inherits(KalturaScheduleEventRecurance, kaltura.KalturaObjectBase);
 ...
 * @param recuranceType int  (insertOnly).
 * @param duration int Duration in seconds.
 * @param categoriesIds string Comma separated categories ids.
 ...
 */
function KalturaCreateRecurrencesJobData(){
	KalturaCreateRecurrencesJobData.super_.call(this);
	this.scheduleEventId = null;
}
module.exports.KalturaCreateRecurrencesJobData = KalturaCreateRecurrencesJobData;

util.inherits(KalturaCreateRecurrencesJobData, KalturaJobData);
...
/**
 * @param entryId string Entry id to be used.
 * @param entryTemplate KalturaBaseEntry Entry template to be used to create a new entry.
 */
 ...
 * @param priorityGreaterThanOrEqual int .
 * @param priorityLessThanOrEqual int .
 * @param recuranceTypeEqual int .
 * @param recuranceTypeIn string .
 * @param categoriesIdsMatchAnd string .
...
function KalturaScheduleEventBaseFilter(){
	...
	this.priorityGreaterThanOrEqual = null;
	this.priorityLessThanOrEqual = null;
	this.recuranceTypeEqual = null;
	this.recuranceTypeIn = null;
	this.categoriesIdsMatchAnd = null;
	this.categoriesIdsMatchOr = null;
	this.tagsLike = null;
	this.tagsMultiLikeOr = null;
...
util.inherits(KalturaScheduleEventBaseFilter, KalturaRelatedFilter);
...
util.inherits(KalturaScheduleEventResourceBaseFilter, KalturaRelatedFilter);
...
util.inherits(KalturaScheduleResourceBaseFilter, KalturaRelatedFilter);
